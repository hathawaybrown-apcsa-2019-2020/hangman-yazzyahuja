/**
 *  A class to play the game Hangman.
 *  This class manages the input and output.
 *  The class HangmanGame (to be written by the student) manages
 *  the game play.
 *  
 *  @author  Litvin and Litvin (Chapter 8 Question 21)
 */ 
